    ...
    travelToShow = (
      <>
        ...
        <S.middle>
          <S.block>
            <S.Image2
              src={`${process.env.PUBLIC_URL}/home/list/list5.png`}
              alt="Description"
            />
            <S.icon>
              <button onClick={() => handleFavoriteClick("heart5")}>
                <FontAwesomeIcon
                  icon={favorites["heart5"] ? fasHeart : farHeart}
                />
              </button>
            </S.icon>
          </S.block>
        ...
        <S.middle>
          <S.block>
            <S.Image2
              src={`${process.env.PUBLIC_URL}/home/list/list6.png`}
              alt="Description"
            />
            <S.icon>
              <button onClick={() => handleFavoriteClick("heart6")}>
                <FontAwesomeIcon
                  icon={favorites["heart6"] ? fasHeart : farHeart}
                />
              </button>
            </S.icon>
          </S.block>
        ...
        <S.middle>
          <S.block>
            <S.Image2
              src={`${process.env.PUBLIC_URL}/home/list/list7.png`}
              alt="Description"
            />
            <S.icon>
              <button onClick={() => handleFavoriteClick("heart7")}>
                <FontAwesomeIcon
                  icon={favorites["heart7"] ? fasHeart : farHeart}
                />
              </button>
            </S.icon>
          </S.block>
        ...
        <S.middle>
          <S.block>
            <S.Image2
              src={`${process.env.PUBLIC_URL}/home/list/list8.png`}
              alt="Description"
            />
            <S.icon>
              <button onClick={() => handleFavoriteClick("heart8")}>
                <FontAwesomeIcon
                  icon={favorites["heart8"] ? fasHeart : farHeart}
                />
              </button>
            </S.icon>
          </S.block>
    ...
    if (myPageContent === "사랑하는 사람과" && boardContent === "평화롭게") {
      content = (
        <Slider {...settings}>
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme1.png`}
              alt="Description"
            />
            <p className="small">[순우리여행]</p>
            <p className="big">쏠라티 단독 한려수도권 2박3일</p>
            <p className="big" style={{ color: "red" }}>
              1,050,000원
            </p>
          </S.play>
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme2.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme3.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme4.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme5.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme6.png`}
              alt="Description"
            />
      ...
      content = (
        <Slider {...settings}>
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme7.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme8.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme9.png`}
              alt="Description"
            />
            <p className="small">#남도</p>
      ...
      content = (
        <Slider {...settings}>
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme10.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme11.png`}
              alt="Description"
            />
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme12.png`}
              alt="Description"
            />
            <p className="small">#숙박여행</p>
            <p className="big">내생애 꼭 가봐야할 한려수도권 2박3일</p>
          ...
          <S.play>
            <S.Image3
              src={`${process.env.PUBLIC_URL}/home/theme/theme13.png`}
              alt="Description"
            />
            <p className="small">#동해안</p>
            <p className="big">내생애 꼭 가봐야할 동해안권 2박3일</p>
      ...
      <S.Section>
        ...
        <S.keyword>
          <S.DropdownContainer>
            ...
            <S.Menu isDropped={myPageIsOpen}>
              <S.Ul>
                <S.Li>
                  <S.LinkWrapper
                    onClick={() => handleMenuClick1("사랑하는 사람과")}
                  >
                    사랑하는 사람과
                  </S.LinkWrapper>
                </S.Li>
                <S.Li>
                  <S.LinkWrapper onClick={() => handleMenuClick1("가족과")}>
                    가족과
                  </S.LinkWrapper>
                </S.Li>
                <S.Li>
                  <S.LinkWrapper onClick={() => handleMenuClick1("친구들과")}>
                    친구들과
                  </S.LinkWrapper>
                </S.Li>
              </S.Ul>
          ...
          <S.DropdownContainer>
            ...
            <S.Menu isDropped={boardIsOpen}>
              <S.Ul>
                <S.Li>
                  <S.LinkWrapper onClick={() => handleMenuClick2("평화롭게")}>
                    평화롭게
                  </S.LinkWrapper>
                </S.Li>
                <S.Li>
                  <S.LinkWrapper onClick={() => handleMenuClick2("신나게")}>
                    신나게
                  </S.LinkWrapper>
                </S.Li>
                <S.Li>
                  <S.LinkWrapper onClick={() => handleMenuClick2("감성있게")}>
                    감성있게
                  </S.LinkWrapper>
                </S.Li>
              </S.Ul>
        ...
        <S.Grids>
          ...
          <S.Grid>
            <S.Image4
              id="2"
              src={`${process.env.PUBLIC_URL}/home/grid/grid1.png`}
              alt="Description"
            />
            <p className="price">
              제주 #우도관광 #마라도 or#가파도 #식사 ALL 포함
            </p>
          ...
          <S.Grid>
            <S.Image4
              id="3"
              src={`${process.env.PUBLIC_URL}/home/grid/grid2.png`}
              alt="Description"
            />
            <p className="price">
              제주 3일 #BEST추천여행 #제주현지특식 #노쇼핑 #노팁 #노옵션
            </p>
          ...
          <S.Grid>
            <S.Image4
              id="4"
              src={`${process.env.PUBLIC_URL}/home/grid/grid3.png`}
              alt="Description"
            />
            <p className="price">
              제주 #우도단독버스투어 #제주핵심명소 #식사ALL포함 #섬여행
            </p>
          ...
          <S.Grid>
            <S.Image4
              id="5"
              src={`${process.env.PUBLIC_URL}/home/grid/grid4.png`}
              alt="Description"
            />
          ...
          <S.Grid>
            <S.Image4
              id="6"
              src={`${process.env.PUBLIC_URL}/home/grid/grid5.png`}
              alt="Description"
            />
            <p className="price">
              제주3일#HOT추천여행 #가파도 #송악산둘레길 #비자림
            </p>
          ...
          <S.Grid>
            <S.Image4
              id="7"
              src={`${process.env.PUBLIC_URL}/home/grid/grid6.png`}
              alt="Description"
            />
            <p className="price">
              제주 3일 #차귀도 섬탐방 #하늘연못 인생샷 #드라마촬영지 #환상숲
            </p>
          ...
          <S.Grid>
            <S.Image4
              id="8"
              src={`${process.env.PUBLIC_URL}/home/grid/grid7.png`}
              alt="Description"
            />
